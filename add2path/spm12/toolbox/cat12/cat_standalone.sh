...
# ______________________________________________________________________
# $Id: cat_standalone.sh 1984 2022-04-19 07:59:02Z gaser $

########################################################
# global parameters
########################################################
version='cat_standalone.sh $Id: cat_standalone.sh 1984 2022-04-19 07:59:02Z gaser $'
...
exit_if_empty ()
{
  ...
  if [ ! -n "$val" ]; then
    echo 'WARNING: No argument given with \"$desc\" command line argument!' >&2
  fi
}
